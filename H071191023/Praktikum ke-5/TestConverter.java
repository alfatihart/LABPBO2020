public class TestConverter
{
	public static void main(String[] args)
	{
		...
		temp.start();
		// tanda !compare untuk membandingkan  antara temperatur dari satu ke yang lainnya kak
		// untuk celcius ke farenheitnya 32 (32 sdh ketentuan konversinya)
