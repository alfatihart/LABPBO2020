...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        String name = bayu.next();
        System.out.println("role");
        String role = bayu.next();
        ...
        System.out.println("name");
        String name2 = bayu.next();
        System.out.println("role");
        String role2 = bayu.next();
